...
export const CALIBER_PRESETS: CaliberPreset[] = [
  ...
  { inches: 0.510, mm: 12.95, designation: ".500 Jeffery / .505 Gibbs (.505-.510)", category: 'African Express & Dangerous Game', commonCartridges: ".500 Jeffery, .505 Gibbs, .500 Nitro Express", typicalWeightGrains: 570, typicalBulletLength: 1.68, typicalSeatingDepth: 0.50 },
